...
let uniqueID = IOHIDDeviceGetProperty(device, kIOHIDPhysicalDeviceUniqueIDKey as CFString)
print("device=\(product ?? "?" as CFString) uniqueID=\(uniqueID ?? "?" as CFString)")
...
let demoLights = CommandLine.arguments.contains("--demo-lights")
let json = demoLights
    ? "{\"method\":\"v.oai.thstatus\",\"params\":[{\"id\":0,\"c\":16777215,\"b\":1,\"e\":\"off\",\"s\":0},{\"id\":1,\"c\":1754367,\"b\":1,\"e\":\"breath\",\"s\":1},{\"id\":2,\"c\":4521796,\"b\":1,\"e\":\"off\",\"s\":0},{\"id\":3,\"c\":16753920,\"b\":1,\"e\":\"off\",\"s\":0},{\"id\":4,\"c\":16724787,\"b\":1,\"e\":\"off\",\"s\":0},{\"id\":5,\"c\":0,\"b\":0,\"e\":\"off\",\"s\":0}],\"id\":4243}\n"
    : "{\"method\":\"device.status\",\"params\":{},\"id\":4242}\n"
